# sending to arduino (separate Queues)
...
def send_rgb_to_arduino(rgb_color):
    print("send: ", rgb_color)
    pass


def send_rgb_to_arduino1(rgb_color):
    """sending RGB color value to Arduino"""
    if isinstance(rgb_color, tuple) and len(rgb_color) == 3: 
        ...
        print(f"Invalid response from OpenAI: {rgb_color}")
